var e=e=>e.toLowerCase().replace(/[^a-z0-9]+/g,`-`).replace(/(^-|-$)/g,``),t=[{id:5,title:`Harga Lampu Jalan Tenaga Surya 2025: Simak Dahulu Sebelum Membeli`,date:`Agustus 25, 2025`,category:`Panduan`,image:`/blog1.jpg`,excerpt:`Lampu jalan tenaga surya telah menjadi pilihan populer untuk penerangan jalan di berbagai daerah. Ketahui harga dan faktor pertimbangannya.`,content:`
    ...
    `,author:`Tim Konsultan Niscahya`},{id:1,title:`Lampu PJU Tenaga Surya Hybrid: Menggabungkan Listrik PLN dan Tenaga Surya`,date:`Januari 13, 2026`,category:`Teknologi`,image:`/PJU TENAGA SURYA.jpeg`,excerpt:`Apa itu sistem hybrid? Simak bagaimana penggabungan dua sumber daya ini dapat meningkatkan efisiensi dan keandalan penerangan jalan Anda.`,content:`
    ...
    `,author:`Tim Ahli Niscahya`},{id:2,title:`Lithium vs VRLA? Pilih yang Mana untuk Sistem Solar Anda?`,date:`Oktober 2, 2025`,category:`Komparasi`,image:`/blog6.jpg`,excerpt:`Masih bingung memilih jenis baterai? Kami bandingkan performa, harga, dan daya tahan antara baterai Lithium dan VRLA.`,content:`
    ...
    `,author:`Tim Riset Niscahya`},{id:3,title:`Jenis-Jenis Tiang Lampu Jalan Tenaga Surya dan Fungsinya`,date:`Agustus 28, 2025`,category:`Edukasi`,image:`/blog5.jpg`,excerpt:`Dari tiang oktagonal hingga galvanis, ketahui jenis tiang yang paling cocok untuk kebutuhan proyek Anda.`,content:`
    ...
    `,author:`Divisi Teknik`},{id:4,title:`Aetheria 100W vs Nebula High-Bay: Mana yang Lebih Terang?`,date:`Juni 2, 2025`,category:`Produk`,image:`/blog4.jpg`,excerpt:`Perbandingan mendalam antara dua produk unggulan kami untuk kebutuhan penerangan area luas.`,content:`
    ...
    `,author:`Product Specialist`},{id:6,title:`All-in-One vs Two-in-One vs Konvensional: Mana yang Paling Untung?`,date:`April 10, 2026`,category:`Hot Topic`,image:`/blog3.jpg`,excerpt:`Bingung memilih model PJU Tenaga Surya? Simak kelebihan dan kekurangan masing-masing model untuk proyek Anda.`,content:`
    ...
    `,author:`Tim Ahli Niscahya`},{id:7,title:`5 Tips Perawatan PJU Tenaga Surya Agar Awet Hingga 10 Tahun`,date:`Maret 15, 2026`,category:`Tips`,image:`/blog2.jpg`,excerpt:`Jangan biarkan investasi Anda rusak karena kurang perawatan. Ikuti langkah sederhana ini agar sistem solar Anda tetap prima.`,content:`
    ...
    `,author:`Divisi Teknik`},{id:8,title:`Musim Hujan Tiba! Apakah PJU Tenaga Surya Tetap Bisa Menyala?`,date:`Februari 20, 2026`,category:`Hot Topic`,image:`https://images.unsplash.com/photo-1515694346937-94d85e41e6f0?q=80&w=1000&auto=format&fit=crop`,excerpt:`Kekhawatiran terbesar pengguna adalah saat mendung berkepanjangan. Simak bagaimana teknologi kami menangani cuaca buruk.`,content:`
    ...
    `,author:`Tim Riset Niscahya`},{id:9,title:`Cara Memilih Lampu Panel Surya Terbaik untuk Kebutuhan Anda`,date:`April 21, 2026`,category:`Panduan`,image:`/blog1.jpg`,excerpt:`Jangan salah pilih! Simak panduan lengkap memilih lampu panel surya dengan efisiensi tinggi dan durabilitas jangka panjang.`,content:`
    ...
    `,author:`Tim Konsultan Niscahya`},{id:10,title:`Perbandingan Lampu Tenaga Surya vs Listrik Biasa (PLN)`,date:`April 21, 2026`,category:`Komparasi`,image:`/blog2.jpg`,excerpt:`Mana yang lebih hemat? Kami bedah perbandingan biaya investasi awal hingga biaya operasional antara sistem Solar dan PLN.`,content:`
    ...
    `,author:`Tim Riset Niscahya`},{id:11,title:`Apakah Lampu Solar Cocok untuk Rumah? Ini Penjelasannya`,date:`April 21, 2026`,category:`Edukasi`,image:`/blog3.jpg`,excerpt:`Tenaga surya bukan hanya untuk jalan raya. Pelajari bagaimana sistem solar dapat diaplikasikan untuk hunian pribadi Anda.`,content:`
    ...
    `,author:`Product Specialist`}].map(t=>({...t,slug:e(t.title)}));export{t};